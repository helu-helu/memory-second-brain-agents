...
$(window).on("load", function() {
    ...
    function loop(links, ul) {
        ...
        // children: An array of child link objects
        $.each(links, function(_, obj) {
            ...
            // apply styling if this is the current page:
    ...
    // focus the table of contents on the current page by scrolling to it:
