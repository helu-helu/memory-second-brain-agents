...
When you [create your package](cus-create.html) with the Package Manager window, the operation creates a `Third Party Notices.md` file in base folder of your package. Update this file if your package has third-party elements.
