...
**Note**: Some platforms might require you to install additional dependencies alongside the platform build support component. Refer to [Platform development](PlatformSpecific.html) to understand the dependency requirement of the supported platforms.
