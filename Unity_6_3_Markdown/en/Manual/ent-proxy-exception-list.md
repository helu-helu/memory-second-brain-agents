...
| `config.uca.cloud.unity3d.com` | Unity Hub | Opt-in status for **analytics**Abbreviation of **Unity Analytics** See in [Glossary](Glossary.html#Analytics), by using remote configuration. |
...
| `packages-v2.unity.com` | Unity Package Registry | Previously used by **Asset Store**A growing library of free and commercial assets created by Unity and members of the community. Offers a wide variety of assets, from textures, models and animations to whole project examples, tutorials and Editor extensions. [More info](AssetStore.html) See in [Glossary](Glossary.html#AssetStore) integration in the Package Manager. Alias for `packages.unity.com`. |
...
**Important**: Proceed to [Endpoints that download executable files](ent-proxy-exception-list.html#endpoints-exe) and add the URLs from that list.
