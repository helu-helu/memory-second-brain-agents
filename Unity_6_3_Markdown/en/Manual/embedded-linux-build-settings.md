...
Use the Embedded Linux build settings to configure and build your application for the Embedded Linux platform. The Embedded Linux build settings are included in the **Platform Settings** section of the [Build Profiles window](BuildSettings.html).
