...
See in [Glossary](Glossary.html#Scene) that demonstrates the player authentication process. You can use the **scripts**A piece of code that allows you to create your own Components, trigger game events, modify Component properties over time and respond to user input in any way you like. [More info](creating-scripts.html)  
See in [Glossary](Glossary.html#Scripts) in this Building Block to authenticate players in your own project. For more information, refer to [Add the Player Accounts Building Block to a different scene](#add-the-player-accounts-building-block-to-a-different-scene).
...
* Follow the instructions in the [LiveOps Building Blocks prerequisites](building-blocks-liveops-prerequisites.html).
* Install the [Unity Building Block - Player Account](https://assetstore.unity.com/packages/essentials/tutorial-projects/unity-building-block-player-account-341928) from the Unity **Asset Store**A growing library of free and commercial assets created by Unity and members of the community. Offers a wide variety of assets, from textures, models and animations to whole project examples, tutorials and Editor extensions. [More info](AssetStore.html)  
...
1. Follow the instructions in [LiveOps Building Blocks prerequisites](building-blocks-liveops-prerequisites.html) to set up deployment in your project.
...
2. In the ****Viewport**The user’s visible area of an app on their screen.  
   See in [Glossary](Glossary.html#viewport)** **toolbar**A row of buttons and basic controls at the top of the Unity Editor that allows you to interact with the Editor in various ways (e.g. scaling, translation). [More info](Toolbar.html)  
   See in [Glossary](Glossary.html#toolbar), select the **Blocks Runtime Theme**.
...
To learn more about UI builder, refer to [UI Builder](UIBuilder.html).
