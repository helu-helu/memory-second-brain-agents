...
| --- | --- | --- | --- |
| [Generator](audio-scriptable-processors-generators.html) | **Audio sources**A component which plays back an Audio Clip in the scene to an audio listener or through an audio mixer. [More info](class-AudioSource.html) See in [Glossary](Glossary.html#AudioSource) | Produces audio samples | Custom sound generators that emit audio into a **scene**A Scene contains the environments and menus of your game. Think of each unique Scene file as a unique level. In each Scene, you place your environments, obstacles, and decorations, essentially designing and building your game in pieces. [More info](CreatingScenes.html) See in [Glossary](Glossary.html#Scene), typically via an `AudioSource`. |
| [Root output](audio-scriptable-processors-root-outputs.html) | Audio engine main output | Produces audio samples | Custom audio systems with job system access, integration of middlewares, or sound generators that emit audio directly to the main output mix. |
