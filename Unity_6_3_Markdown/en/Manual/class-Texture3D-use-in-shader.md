...
To use a 3D texture in a custom **shader**A program that runs on the GPU. [More info](Shaders.html)  
...
The volume Unity renders if you use the example shader with the 3D texture from the [Create a 3D texture in a script](class-Texture3D-create.html) page.
